...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'student_list' => \App\Http\Middleware\StudentList::class,
        'student_high' => \App\Http\Middleware\StudentHigherPermission::class,
        'student_settings' => \App\Http\Middleware\StudentSettings::class,
        ...
        'student_class_page' => \App\Http\Middleware\StudentClass::class,
