<div class="modal fade" id="prev_employment_modal">
    <div class="modal-dialog" style="width: 100%; max-width: 600px;">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="prev_employment_form">
                @csrf
                <div class="modal-body clearfix">
                    <input type="hidden" name="pe_id" id="pe_id">
                    <input type="hidden" name="pe_emp_id" id="pe_emp_id">
                    <input type="hidden" name="pe_add_edit" id="pe_add_edit">
