...
$(document).ready(function () {
    ...
    function refresh() {
        ...
        if (current_tab != 'Student' && current_tab != 'SSW' && current_tab != 'Request History' && current_tab != 'Release History') {
            $('.invoice_select').show();
        ...
        switch (current_tab) {
            ...
            case 'SSW':
                refresh_books_ssw_student_table();break;
            case 'Books':
                refresh_books();break;
    ...
    function refresh_request_books() {
        var request_books_table = $('#books_request_table').DataTable({
            ...
            buttons: [{ extend: 'excelHtml5', title: 'Books',
                exportOptions: {
                    columns: ':visible'
                } }, 'colvis'],
    ...
    function refresh_books() {
        ...
        }), _defineProperty(_$$DataTable, 'columns', [{ data: 'book_type.description', name: 'book_type' }, { data: 'name', name: 'book_no' }, { data: 'reference_no.invoice_ref_no', name: 'invoice_ref_no' }, { data: 'branch.name', name: 'branch' }, { data: 'status', name: 'status' }, { data: 'student_name', name: 'student_name' }, { data: 'action', orderable: false, searchable: false }]), _$$DataTable));
    }
    ...
    function refresh_books_ssw_student_table() {
        ...
        var books_ssw_student_table = $('#books_ssw_student_table').DataTable({
            ...
            columns: [{ data: 'student_name', name: 'student_name' }, { data: 'branch.name', name: 'branch' }, { data: 'book_1_ssw', name: 'book_1_ssw' }, { data: 'wb_1_ssw', name: 'wb_1_ssw' }, { data: 'book_2_ssw', name: 'book_2_ssw' }, { data: 'wb_2_ssw', name: 'wb_2_ssw' }, { data: 'kanji_ssw', name: 'kanji_ssw' }, { data: 'program.name', name: 'program', defaultContent: '' }, { data: 'status', name: 'status' }]
        });
    }
    ...
    function refresh_books_branch_table() {
        ...
        var books_branch_table = $('#books_branch_table').DataTable({
            ...
            columns: [{ data: 'name', name: 'branch' }, { data: 'book_1', name: 'book_1' }, { data: 'wb_1', name: 'wb_1' }, { data: 'book_2', name: 'book_2' }, { data: 'wb_2', name: 'wb_2' }, { data: 'kanji', name: 'kanji' }, { data: 'book_1_ssw', name: 'book_1_ssw' }, { data: 'wb_1_ssw', name: 'wb_1_ssw' }, { data: 'book_2_ssw', name: 'book_2_ssw' }, { data: 'wb_2_ssw', name: 'wb_2_ssw' }, { data: 'kanji_ssw', name: 'kanji_ssw' }]
        });
    }
