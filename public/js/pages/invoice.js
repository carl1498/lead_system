...
$(document).ready(function () {
    ...
    function refresh_invoice() {
        ...
        var invoice_table = $('#invoice_table').DataTable({
            ...
            columns: [{ data: 'reference_no.invoice_ref_no', name: 'invoice_ref_no' }, { data: 'book_1', name: 'book_1' }, { data: 'wb_1', name: 'wb_1' }, { data: 'book_2', name: 'book_2' }, { data: 'wb_2', name: 'wb_2' }, { data: 'kanji', name: 'kanji' }, { data: 'book_1_ssv', name: 'book_1_ssv' }, { data: 'wb_1_ssv', name: 'wb_1_ssv' }, { data: 'book_2_ssv', name: 'book_2_ssv' }, { data: 'wb_2_ssv', name: 'wb_2_ssv' }, { data: 'kanji_ssv', name: 'kanji_ssv' }, { data: 'created_at', name: 'date' }, { data: 'action', orderable: false, searchable: false }],
            columnDefs: [{ width: 120, targets: 0 }, //invoice ref no
