...
$(document).ready(function () {
    ...
    function refresh_pic_table(id) {
        $('#client_pic_table').DataTable({
            ...
            columns: [{ data: 'name', name: 'name' }, { data: 'position', name: 'position' }, { data: 'contact', name: 'contact' }, { data: 'email', name: 'email' }, { data: 'action', orderable: false, searchable: false }],
            columnDefs: [{ defaultContent: "", targets: "_all" }]
        });
    }
