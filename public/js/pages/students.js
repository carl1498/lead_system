...
$(document).ready(function () {
    ...
    function enableTabs() {
        ...
        switch (current_switch) {
            case 'SSV':
                $('.switch_student, .switch_trainee').attr('disabled', false);break;
            case 'Student':
                $('.switch_ssv, .switch_trainee').attr('disabled', false);break;
            case 'Trainee':
                $('.switch_student, .switch_ssv').attr('disabled', false);break;
        }
    }
    ...
    var columns_trainee_students = [{ data: 'name', name: 'name' }, { data: 'company.name', name: 'company' }, { data: 'contact', name: 'contact' }, { data: 'gender', name: 'gender' }, { data: 'birthdate', name: 'birthdate' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'coe_status', name: 'coe_status' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];

    var columnDefs_trainee_students = [{ width: 230, targets: 0 }, //name
    ...
    var buttons_format = [{ extend: 'print', title: 'LEAD System', orientation: 'landscape', pageSize: 'FOLIO',
        exportOptions: {
        ...
        } }, 'excelHtml5', { extend: 'pdfHtml5', title: 'LEAD System', orientation: 'landscape', pageSize: 'FOLIO',
        exportOptions: {
            columns: [0, 1, 2, 3, 4, 5, 6, 7, 13],
            fontSize: 8
        },
