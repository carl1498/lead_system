...
$(document).ready(function () {
    ...
    function disableTabs() {
        $('li.branch_pick, li.status_pick, li.result_pick, \n        li.language_pick, li.all_pick, li.ssw_pick, li.trainee_pick').addClass('disabled').css('cursor', 'not-allowed');

        $('a.branch_pick, a.status_pick, a.result_pick,\n        a.language_pick, a.all_pick, a.ssw_pick, a.trainee_pick').addClass('disabled').css('pointer-events', 'none');

        $('.switch, .refresh_table').attr('disabled', true);
    }

    function enableTabs() {
        $('li.branch_pick, li.status_pick, li.result_pick, \n        li.language_pick, li.all_pick, li.ssw_pick, li.trainee_pick').removeClass('disabled').css('cursor', 'pointer');

        $('a.branch_pick, a.status_pick, a.result_pick,\n        a.language_pick, a.all_pick, a.ssw_pick, a.trainee_pick').removeClass('disabled').css('pointer-events', 'auto');
        ...
        switch (current_switch) {
            ...
            case 'Student':
                $('.switch_ssw, .switch_trainee').attr('disabled', false);break;
            case 'Trainee':
                $('.switch_student, .switch_ssw').attr('disabled', false);break;
        }
    }
    ...
    var columns_trainee_students = [{ data: 'name', name: 'name' }, { data: 'contact', name: 'contact' }, { data: 'company.name', name: 'company' }, { data: 'gender', name: 'gender' }, { data: 'birthdate', name: 'birthdate' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'coe_status', name: 'coe_status' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];
