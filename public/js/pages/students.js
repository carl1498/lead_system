...
$(document).ready(function () {
    ...
    var columns_ssw_students = [{ data: 'name', name: 'name' }, { data: 'contact', name: 'contact' }, { data: 'gender', name: 'gender' }, { data: 'birthdate', name: 'birthdate' }, { data: 'university', name: 'university' }, { data: 'benefactor.name', name: 'benefactor' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];

    var columns_intern_students = [{ data: 'name', name: 'name' }, { data: 'program.name', name: 'program' }, { data: 'contact', name: 'contact' }, { data: 'benefactor.name', name: 'benefactor' }, { data: 'university.name', name: 'university' }, { data: 'gender', name: 'gender' }, { data: 'birthdate', name: 'birthdate' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' },, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];
