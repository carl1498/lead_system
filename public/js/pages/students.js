...
$(document).ready(function () {
    ...
    function disableTabs() {
        $('li.branch_pick, li.status_pick, li.result_pick, \n        li.language_pick, li.all_pick, li.ssv_pick, li.ssv_backout_pick').addClass('disabled').css('cursor', 'not-allowed');

        $('a.branch_pick, a.status_pick, a.result_pick,\n        a.language_pick, a.all_pick, a.ssv_pick, a.ssv_backout_pick').addClass('disabled').css('pointer-events', 'none');

        $('.switch, .refresh_table').attr('disabled', true);
    }

    function enableTabs() {
        $('li.branch_pick, li.status_pick, li.result_pick, \n        li.language_pick, li.all_pick, li.ssv_pick, li.ssv_backout_pick').removeClass('disabled').css('cursor', 'pointer');

        $('a.branch_pick, a.status_pick, a.result_pick,\n        a.language_pick, a.all_pick, a.ssv_pick, a.ssv_backout_pick').removeClass('disabled').css('pointer-events', 'auto');
    ...
    function refresh() {
        ...
        switch (current_tab) {
            ...
            case 'SSV':
                refresh_ssv_student();break;
            case 'SSV Backout':
                refresh_ssv_backout();break;
            case 'All':
    ...
    var columns_students = [{ data: 'name', name: 'name' }, { data: 'contact', name: 'contact' }, { data: 'program.name', name: 'program' }, { data: 'school.name', name: 'school' }, { data: 'benefactor.name', name: 'benefactor' }, { data: 'gender', name: 'gender' }, { data: 'age', name: 'age' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'date_of_signup', name: 'date_of_signup' }, { data: 'referral.fname', name: 'referral' }, { data: 'status', name: 'status' }, { data: 'coe_status', name: 'coe_status' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];

    var columnDefs_students = [{ width: 230, targets: 0 }, //name
    ...
    var columns_students_status = [{ data: 'name', name: 'name' }, { data: 'branch.name', name: 'branch' }, { data: 'contact', name: 'contact' }, { data: 'program.name', name: 'program' }, { data: 'school.name', name: 'school' }, { data: 'benefactor.name', name: 'benefactor' }, { data: 'gender', name: 'gender' }, { data: 'age', name: 'age' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'date_of_signup', name: 'date_of_signup' }, { data: 'referral.fname', name: 'referral' }, { data: 'status', name: 'status' }, { data: 'coe_status', name: 'coe_status' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];

    var columnDefs_students_status = [{ width: 230, targets: 0 }, { width: 70, targets: 1 }, { width: 90, targets: 2 }, { width: 130, targets: 3 }, { width: 130, targets: 4 }, { width: 130, targets: 5 }, { width: 60, targets: 6 }, { width: 45, targets: 7 }, { width: 200, targets: 8 }, { width: 200, targets: 9 }, { width: 120, targets: 10 }, { width: 120, targets: 11 }, { width: 100, targets: 12 }, { width: 100, targets: 13 }, { width: 250, targets: 14 }, { width: 150, targets: 15 }, { defaultContent: "", targets: "_all" }];

    var columns_students_result = [{ data: 'name', name: 'name' }, { data: 'branch.name', name: 'branch' }, { data: 'program.name', name: 'program' }, { data: 'school.name', name: 'school' }, { data: 'status', name: 'status' }, { data: 'coe_status', name: 'coe_status' }, { data: 'referral.fname', name: 'referral' }, { data: "action", orderable: false, searchable: false }];

    var columnDefs_students_result = [{ width: 230, targets: 0 }, { width: 70, targets: 1 }, { width: 90, targets: 2 }, { width: 130, targets: 3 }, { width: 100, targets: 4 }, { width: 100, targets: 5 }, { width: 120, targets: 6 }, { width: 150, targets: 7 }, { defaultContent: "", targets: "_all" }];

    var columns_language_students = [{ data: 'name', name: 'name' }, { data: 'branch.name', name: 'branch' }, { data: 'contact', name: 'contact' }, { data: 'gender', name: 'gender' }, { data: 'age', name: 'age' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'referral.fname', name: 'referral' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];

    var columnDefs_language_students = [{ width: 230, targets: 0 }, //name
    ...
    var columns_ssv_students = [{ data: 'name', name: 'name' }, { data: 'contact', name: 'contact' }, { data: 'gender', name: 'gender' }, { data: 'age', name: 'age' }, { data: 'program.name', name: 'program' }, { data: 'benefactor.name', name: 'benefactor' }, { data: 'course.name', name: 'course' }, { data: 'email', name: 'email' }, { data: 'referral.fname', name: 'referral' }, { data: 'remarks', name: 'remarks' }, { data: "action", orderable: false, searchable: false }];

    var columnDefs_ssv_students = [{ width: 230, targets: 0 }, //name
    { width: 90, targets: 1 }, //contact
    ...
    function view_profile(id) {
        $.ajax({
            ...
            success: function success(data) {
                ...
                if (data.program) {
                    if (data.program.name != 'Language Only' && data.program.name != 'SSV (Careworker)' && data.program.name != 'SSV (Hospitality)') {
