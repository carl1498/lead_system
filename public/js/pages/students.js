...
$(document).ready(function () {
    ...
    function disableTabs() {
        $('li.branch_pick, li.status_pick, li.result_pick, \n        li.language_pick, li.all_pick, li.ssw_pick, li.titp_pick').addClass('disabled').css('cursor', 'not-allowed');

        $('a.branch_pick, a.status_pick, a.result_pick,\n        a.language_pick, a.all_pick, a.ssw_pick, a.titp_pick').addClass('disabled').css('pointer-events', 'none');

        $('.switch, .refresh_table').attr('disabled', true);
    }

    function enableTabs() {
        $('li.branch_pick, li.status_pick, li.result_pick, \n        li.language_pick, li.all_pick, li.ssw_pick, li.titp_pick').removeClass('disabled').css('cursor', 'pointer');

        $('a.branch_pick, a.status_pick, a.result_pick,\n        a.language_pick, a.all_pick, a.ssw_pick, a.titp_pick').removeClass('disabled').css('pointer-events', 'auto');

        $('.refresh_table').attr('disabled', false);

        switch (current_switch) {
            case 'SSW':
                $('.switch_student, .switch_titp').attr('disabled', false);break;
            case 'Student':
                $('.switch_ssw, .switch_titp').attr('disabled', false);break;
            case 'TITP':
