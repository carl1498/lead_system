...
$(document).ready(function () {
    ...
    function load() {
        var student_add_history = $('#student_add_history').DataTable({
            ...
            columns: [{ data: 'stud_id', name: 'student' }, { data: 'student.program.name', name: 'program' }, { data: 'type', name: 'type' }, { data: 'added_by', name: 'added_by' }, { data: 'created_at', name: 'created_at' }],
